...
import styles from './SpocsConfig.module.css'
...
const SpocsConfig = () => {
    ...
    const [isSpocAddModalOpen, setIsSpocAddModalOpen] = useState(false);
    ...
    return (
        <>
            <Box className={styles.SpocsConfig_container}>
                <Box className={styles.SpocsConfig_container_head}>
                    <Stack className={styles.SpocsConfig_container_head_title}>SPOCs</Stack>
                    <Stack display={"flex"} flexDirection={"row"} gap={"5px"}>
                        ...
                        <Stack className={styles.SpocsConfig_container_head_Btn} onClick={() => { setIsSpocAddModalOpen(true) }}>
                            <Stack>+</Stack>
                            <Stack sx={{ whiteSpace: "nowrap" }}>New SPOC</Stack>
                        </Stack>
                    </Stack>
                </Box>

                {/* Table */}
                <Box className={styles.SpocsConfig_container_table}>
                    <Box height={'100%'}>
                                        ...
                                        <Box className={styles.default_screen}>
                                            <Stack className={styles.default_screen_content}>
                                                ...
                                                <Stack className={styles.default_head2}>
                                                    It looks like you haven't added any Spocs yet. Tap on "Add Spoc" to get started!
                                                </Stack>
                                            </Stack>
                ...
                <Box className={styles.SpocsConfig_container_pagination}>
                    Pagination
                </Box>
            </Box>
            ...
            >
                <Box className={styles.add_modal}>
                    <Stack className={styles.add_modal_head}>
                        <Stack className={styles.add_modal_head_title}>New Spoc</Stack>
                        <Stack
                            className={styles.modal_close}
                            onClick={() => { setIsSpocAddModalOpen(false) }}
                        >
                    ...
                    <Stack className={styles.add_modal_btn}>
                        <Stack className={styles.active_actions}>
                            ...
                            <Stack className={styles.active}>Active this Spoc</Stack>
                        </Stack>
