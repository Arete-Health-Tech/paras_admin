...
import styles from './CordinatorConfig.module.css'
...
const CordinatorConfig = () => {
    const outerTheme = useTheme();
    const [isNewCordinator, setIsNewCordinator] = useState(false);
    ...
    const [isCordinatorAddModalOpen, setIsCordinatorAddModalOpen] = useState(false);
    ...
    return (
        <>
            <Box className={styles.CordinatorConfig_container}>
                <Box className={styles.CordinatorConfig_container_head}>
                    <Stack className={styles.CordinatorConfig_container_head_title}>Cordinators</Stack>
                    <Stack display={"flex"} flexDirection={"row"} gap={"5px"}>
                        ...
                        {/* <Stack className={styles.CordinatorConfig_container_head_Btn0}>
                            <Stack sx={{ whiteSpace: "nowrap" }}>Import CSV</Stack>
                        </Stack> */}
                        <Stack className={styles.CordinatorConfig_container_head_Btn} onClick={() => { setIsCordinatorAddModalOpen(true) }}>
                            <Stack>+</Stack>
                            <Stack sx={{ whiteSpace: "nowrap" }}>New Cordinator</Stack>
                        </Stack>
                    </Stack>
                </Box>


                <Box className={styles.CordinatorConfig_container_table}>
                    <Box height={'100%'}>
                            ...
                            <Box sx={{ position: "sticky" }}>
                                <thead>
                                    <tr className={styles.table_head}>
                                        ...
                                        <th className={`${styles.table_head_item} ${styles.item7}`}>Unit</th>
                                ...
                                {true ?
                                    <tbody>
                                        <tr className={styles.table_body}>
                                            ...
                                            {/* Unit*/}
                                            <td className={`${styles.table_body_item} ${styles.body_item7}`}>
                                                Hoshiarpur
                                            </td>
                                            ...
                                            <Box className={styles.default_screen}>
                                                <Stack className={styles.default_screen_content}>
                                                    ...
                                                    <Stack className={styles.default_head2}>
                                                        It looks like you haven't added any Coordinator yet. Tap on "Add Coordinator" to get started!
                                                    </Stack>
                                                </Stack>
                ...
                <Box className={styles.CordinatorConfig_container_pagination}>
                    Pagination
                </Box>
            </Box>
            ...
            >
                <Box className={styles.add_modal}>
                    <Stack className={styles.add_modal_head}>
                        <Stack className={styles.add_modal_head_title}>Add Cordinator</Stack>
                        <Stack
                            className={styles.modal_close}
                            onClick={() => { setIsCordinatorAddModalOpen(false) }}
                        >
                    ...
                    <Stack className={styles.add_modal_field}>
                        ...
                        <FormControl fullWidth>
                            <InputLabel id="demo-simple-select-label" sx={materilaFieldCss}>Select Department(Optional)</InputLabel>
                            <Select
...
export default CordinatorConfig
